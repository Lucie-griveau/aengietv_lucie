...
if(!active){
    ...
    navigator.getUserMedia({
        ...
        document.getElementById("local-video").srcObject = localStream
         ...
         document.getElementById("btnStreamNow").innerHTML = "<svg width=\"24px\" height=\"24px\" viewBox=\"0 0 24 24\"><path d=\"M3.41,1.86 L2,3.27 L4.73,6 L4,6 C3.44771525,6 3,6.44771525 3,7 L3,17 C3,17.5522847 3.44771525,18 4,18 L16,18 C16.21,18 16.39,17.92 16.55,17.82 L19.73,21 L21.14,19.59 L12.28,10.73 L3.41,1.86 M5,16 L5,8 L6.73,8 L14.73,16 L5,16 M15,8 L15,10.61 L21,16.61 L21,6.5 L17,10.5 L17,7 C17,6.44771525 16.5522847,6 16,6 L10.39,6 L12.39,8 L15,8 Z\" id=\"Shape\" fill=\"#628890\" fill-rule=\"nonzero\"></path></svg> HANG OFF"
    ...
    stop()
    active = false
    document.getElementById("action-div").style.visibility = "hidden";
}
